"""Token-reduction benchmark - measures how much context the graph engine saves vs naive full-corpus approach."""
...
def run_benchmark(
    ...
    """Measure token reduction: corpus tokens vs graph query tokens.
